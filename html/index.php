<?php include 'header.php';?>
    <div class="container">
      <div class="card-deck m-3">
        <div class="card m-10 shadow-sm">
          <div class="card-body">
            <h3 class="card-heading">WELCOME TO TECH MATE
              <br>
              <div class="card-sub-heading">Your mate when there's tech trouble</div>
            </h3>
            <p class="card-text">
              Here at Tech Mate our aim is to provide simple and budget solutions to technological problems.
            </p>
